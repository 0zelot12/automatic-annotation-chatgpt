...
result = [
    ...
    "Evanstonian",
    ",",
    "<actor>the room-service manager</actor>",
    "<activity>takes down</activity>",
    "the",
    "order",
    ".",
    "She",
    ...
    "kitchen",
    "to",
    "<activity>begin preparing</activity>",
    "the",
    "food",
    ".",
    "She",
    "also",
    "<activity>gives</activity>",
    "an",
    "order",
    "to",
    "the",
    ...
    "the",
    "sommelier",
    "<activity>are doing</activity>",
    "their",
    "tasks",
    ",",
    "the",
    "waiter",
    "<activity>readies</activity>",
    "a",
    "cart",
    "(",
    "i.e",
    ...
    "and",
    "cart",
    "<activity>are ready</activity>",
    ",",
    "the",
    "waiter",
    "<activity>delivers</activity>",
    "it",
    "to",
    "the",
    "guest's room",
    ...
    "the",
    "waiter",
    "<activity>debits</activity>",
    "the",
    "<activity_data>guest's account</activity_data>",
    ".",
    "The",
    "waiter",
    "may",
    "<activity>wait to do</activity>",
    "the",
    "billing",
    "if",
    "he",
    ...
    "order",
    "to",
    "<activity>prepare or deliver</activity>",
    ".",
]
...
for r in result:
    if re.search(actor_annotation_pattern, r):
        tokens = re.sub(annotation_replacement_pattern, "", r).split(" ")
        for token in tokens:
